...
echo -e 'src/cfitsio/fitscopy src/cfitsio/fitscopy.o src/cfitsio/fitscore.o src/cfitsio/fpack \'
echo -e 'src/cfitsio/fpack.o src/cfitsio/fpackutil.o src/cfitsio/funpack src/cfitsio/funpack.o \'
...
echo -e 'src/cfitsio/histo.o src/cfitsio/histoimg.fit src/cfitsio/imcompress.o src/cfitsio/imcopy \'
echo -e 'src/cfitsio/imcopy.o src/cfitsio/iraffits.o src/cfitsio/iter_a src/cfitsio/iter_a.o \'
echo -e 'src/cfitsio/iter_b src/cfitsio/iter_b.o src/cfitsio/iter_c src/cfitsio/iter_c.o \'
...
echo -e 'src/cfitsio/smem.o src/cfitsio/speed.o src/cfitsio/speedcc.fit \'
...
echo -e "\t"'cd src/cfitsio && $(MAKE) && cp libcfitsio.a ../'
echo 'cleanlibfun:'
echo -e "\t"'cd src/fun && $(MAKE) clean'
echo 'cleancfitsio: src/cfitsio'
echo -e "\t"'cd src/fun && $(MAKE) clean'
a=0
for s in $(ls -1 src/*.c)
do
